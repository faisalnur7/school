...
<div class="container-fluid hub-container">
    ...
    <div class="hub-mobile-hide-hero relative overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-500 p-8 mb-8">
        ...
        <div class="relative z-10 flex items-center gap-6">
            ...
            <div>
                <h3 class="text-white text-3xl font-bold m-0">{{ __('Attendance') }}</h3>
                <p class="text-emerald-100 text-base mt-1 mb-0">{{ __('Manage student attendance records') }}</p>
            </div>
        </div>
    </div>
    
    <x-hub-card-browser :cards="$cards" storage-key="attendance" default-view="medium" />
</div>
@endsection
