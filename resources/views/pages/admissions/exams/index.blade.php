...
@endphp
<div class="container-fluid py-4 admission-exams-page">
    <div class="exams-hero mb-4">
        <div class="hero-copy">
            <span class="eyebrow"><i class="fas fa-graduation-cap mr-2"></i>Admission management</span>
            <h1>Admission exams</h1>
            <p>Create, configure, and monitor every admission examination from one place.</p>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        document.querySelectorAll('.js-copy-admission-link').forEach(function (button) {
            button.addEventListener('click', async function () {
                const link = button.dataset.admissionLink;
...
<style>
    .admission-exams-page { color:#172033; }.exams-hero { align-items:center; background:linear-gradient(118deg,#102c46,#116b70 60%,#1599a1); border-radius:16px; box-shadow:0 11px 25px rgba(15,91,100,.17); color:#fff; display:flex; justify-content:space-between; min-height:165px; overflow:hidden; padding:30px 34px; position:relative; }.exams-hero:after { border:1px solid rgba(255,255,255,.16); border-radius:50%; content:''; height:290px; position:absolute; right:-80px; top:-170px; width:290px; }.hero-copy,.hero-button { position:relative; z-index:1; }.eyebrow { color:#a7f3d0; font-size:11px; font-weight:700; letter-spacing:1.2px; text-transform:uppercase; }.exams-hero h1 { font-size:30px; margin:9px 0 6px; }.exams-hero p { color:rgba(255,255,255,.76); font-size:13px; margin:0; }.hero-button { color:#0b5962; font-weight:600; white-space:nowrap; }.overview-card { align-items:center; background:#fff; border:1px solid #e5ebf2; border-radius:12px; box-shadow:0 4px 12px rgba(30,41,59,.05); display:flex; min-height:82px; padding:15px 18px; }.overview-icon { align-items:center; border-radius:10px; display:inline-flex; font-size:17px; height:40px; justify-content:center; margin-right:13px; width:40px; }.icon-blue { background:#eaf2ff;color:#2563eb; }.icon-green { background:#eaf8ef;color:#16a34a; }.icon-cyan { background:#e6f9fb;color:#0891b2; }.overview-card strong,.overview-card span { display:block; }.overview-card strong { font-size:24px; line-height:1; }.overview-card span { color:#8492a6; font-size:11px; margin-top:5px; }.section-title { align-items:center; display:flex; justify-content:space-between; margin-bottom:15px; }.section-title h3 { font-size:18px; margin:0; }.section-title p { color:#8492a6; font-size:12px; margin:4px 0 0; }.live-label { background:#f0fdf4; border-radius:20px; color:#16803c; font-size:10px; padding:7px 11px; }.exam-card { background:#fff; border:1px solid #e5ebf2; border-radius:14px; box-shadow:0 4px 13px rgba(30,41,59,.05); padding:20px; transition:box-shadow .18s ease, transform .18s ease; }.exam-card:hover { box-shadow:0 11px 24px rgba(30,41,59,.11); transform:translateY(-3px); }.exam-card-top { align-items:center; display:flex; justify-content:space-between; }.status-pill { border-radius:20px; font-size:10px; font-weight:600; padding:5px 9px; }.status-pill i { font-size:7px; }.status-active { background:#eaf8ef;color:#16803c; }.status-inactive { background:#f1f5f9;color:#64748b; }.application-count { color:#94a3b8; font-size:10px; }.application-count strong { color:#334155; font-size:13px; }.exam-card h4 { color:#26364a; font-size:18px; margin:20px 0 12px; }.exam-meta { border-bottom:1px solid #edf1f5; display:flex; flex-wrap:wrap; padding-bottom:15px; }.exam-meta span { color:#718096; font-size:11px; margin-right:18px; }.exam-meta i { color:#0f766e; margin-right:6px; }.exam-summary { display:flex; justify-content:space-between; padding:16px 0; }.exam-summary small,.exam-summary strong { display:block; }.exam-summary small { color:#94a3b8; font-size:9px; margin-bottom:4px; }.exam-summary strong { color:#334155; font-size:12px; }.exam-actions { align-items:center; border-top:1px solid #edf1f5; display:flex; flex-wrap:wrap; gap:6px; padding-top:15px; }.exam-actions .btn { margin-right:0; }.exam-actions .dropdown .btn { margin-right:0; }.empty-state { background:#fff; border:1px dashed #cbd5e1; border-radius:14px; padding:65px 20px; text-align:center; width:100%; }.empty-state i { color:#b8c5d3; font-size:32px; }.empty-state h4 { color:#526174; font-size:16px; margin:14px 0 5px; }.empty-state p { color:#94a3b8; font-size:12px; margin-bottom:18px; }
    html[data-theme='dark'] .admission-exams-page .overview-card,
    html.dark .admission-exams-page .overview-card,
    html[data-theme='dark'] .admission-exams-page .exam-card,
    html.dark .admission-exams-page .exam-card {
        background: #111827 !important;
        border-color: #334155 !important;
        color: #e2e8f0 !important;
    }
    html[data-theme='dark'] .admission-exams-page .overview-card strong,
    html.dark .admission-exams-page .overview-card strong,
    html[data-theme='dark'] .admission-exams-page .exam-card h4,
    html.dark .admission-exams-page .exam-card h4 { color: #f8fafc !important; }
    html[data-theme='dark'] .admission-exams-page .overview-card span,
    html.dark .admission-exams-page .overview-card span { color: #94a3b8 !important; }
