...
<div class="container-fluid hub-container">
    <div class="admissions-hub-hero hub-mobile-hide-hero relative mb-8 overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-800 via-teal-700 to-sky-700 p-8 shadow-xl">
