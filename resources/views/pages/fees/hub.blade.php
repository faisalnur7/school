...
<div class="container-fluid hub-container">
    ...
    <div class="hub-mobile-hide-hero relative overflow-hidden rounded-3xl bg-gradient-to-br from-amber-600 via-orange-600 to-red-500 p-8 mb-8">
        ...
        <div class="relative z-10 flex items-center gap-6">
            ...
            <div>
                <h3 class="text-white text-3xl font-bold m-0">{{ __('Fees Management') }}</h3>
                <p class="text-amber-100 text-base mt-1 mb-0">{{ __('Manage fees, payments & collections') }}</p>
            </div>
        </div>
    </div>

    <x-hub-card-browser :sections="$sections" storage-key="fees" default-view="medium" />
</div>
@endsection
