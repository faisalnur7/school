...
<div class="container-fluid">
    <div class="bg-gradient-to-br from-slate-800 to-slate-600 rounded-2xl p-8 mb-8 flex items-center gap-5">
        <i class="fas fa-money-bill text-white text-5xl opacity-80"></i>
        <div>
            <h3 class="text-white text-3xl font-bold m-0">Fees & Accounts</h3>
            <p class="text-slate-300 text-sm mt-1 mb-0">Manage fees, payments & accounts</p>
        </div>
    </div>
