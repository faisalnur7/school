...
<div class="container-fluid hub-container">
    <div class="hub-mobile-hide-hero relative overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-700 via-purple-600 to-pink-500 p-8 mb-8">
        ...
        <div class="relative z-10 flex items-center gap-6">
            ...
            <div>
                <h3 class="text-white text-3xl font-bold m-0">{{ __('Inventory') }}</h3>
                <p class="text-indigo-100 text-base mt-1 mb-0">{{ __('Manage purchases, products, and stock') }}</p>
            </div>
        </div>
    </div>
    
    <x-hub-card-browser :cards="$cards" storage-key="inventory" default-view="medium" />
</div>
@endsection
