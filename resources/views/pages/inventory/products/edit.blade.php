            ...
            <div class="card-body p-3">
                ...
                <div class="row g-2 mb-3">
                    <div class="col-12">
                        ...
                        <input type="text" name="name" value="{{ old('name', $item->name) }}" class="form-control form-control-sm @error('name') is-invalid @enderror" placeholder="Enter product name" required>
                ...
                <div class="row g-2 mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="sku" value="{{ old('sku', $item->sku) }}" class="form-control form-control-sm @error('sku') is-invalid @enderror" placeholder="SKU-001">
                        @error('sku')<small class="text-danger">{{ $message }}</small>@enderror
                    </div>

                    <div class="col-md-4">
                        <label class="form-label small font-weight-600 mb-1">Barcode</label>
                        <input type="text" name="barcode" value="{{ old('barcode', $item->barcode) }}" class="form-control form-control-sm @error('barcode') is-invalid @enderror" placeholder="1234567890">
                        @error('barcode')<small class="text-danger">{{ $message }}</small>@enderror
                    </div>

                    <div class="col-md-4">
                        <label class="form-label small font-weight-600 mb-1">Unit</label>
                        <input type="text" name="unit" value="{{ old('unit', $item->unit) }}" class="form-control form-control-sm @error('unit') is-invalid @enderror" placeholder="pcs, box, kg">
                ...
                <div class="row g-2 mb-3">
                    <div class="col-md-4">
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <input type="number" step="0.01" min="0" name="purchase_price" value="{{ old('purchase_price', $item->purchase_price) }}" class="form-control form-control-sm @error('purchase_price') is-invalid @enderror" placeholder="0.00">
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group input-group-sm">
                            <input type="number" min="0" name="minimum_stock_alert" value="{{ old('minimum_stock_alert', $item->minimum_stock_alert) }}" class="form-control form-control-sm @error('minimum_stock_alert') is-invalid @enderror" placeholder="0">
                ...
                <div class="row g-2 mb-3">
                    <div class="col-12">
                        ...
                        <textarea name="description" class="form-control form-control-sm @error('description') is-invalid @enderror" rows="2" placeholder="Enter product description...">{{ old('description', $item->description) }}</textarea>
                        @error('description')<small class="text-danger">{{ $message }}</small>@enderror
                    </div>
                </div>

                <!-- Row 6: Current Stock Info -->
                <div class="row g-2 mb-3">
                    <div class="col-12">
                        <div class="alert alert-info alert-sm border-0 py-2 px-3 mb-0">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="section_id" class="form-control form-control-sm @error('section_id') is-invalid @enderror">
                                ...
                                @foreach($sections as $s)
                                    <option value="{{ $s->id }}" {{ old('section_id', $item->section_id) == $s->id ? 'selected' : '' }}>
                                        {{ $s->name_en }}
                                    </option>
                                @endforeach
                            </select>
