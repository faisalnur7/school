...
@section('contents')
    <div class="container-fluid px-3 py-3">
        <div class="card shadow-sm border-0">
            ...
            <form method="POST" action="{{ route('roles.update', $role) }}" id="modernForm">
                @csrf
                                ...
                                @foreach ($permissions as $category => $perms)
                                    ...
                                    <div class="col-lg-4 col-md-6 mb-3">
                                        <div class="card border h-100">
                                            ...
                                            {{-- Header --}}
                                            <div
                                                class="card-header py-2 px-3 bg-light d-flex justify-content-between align-items-center">
                                                <span class="font-weight-bold text-white">
                                                    {{ $category ?? 'General' }}
                                                </span>

                                                <label class="mb-0 text-white ml-auto " style="cursor:pointer;">
                                                    ...
                                                    @foreach ($perms as $permission)
                                                        <div class="col-12 mb-2">
                                                            <div class="custom-control custom-checkbox">
                                                                <input type="checkbox"
                                                                    class="custom-control-input perm-check cat_{{ Str::slug($category ?? 'general') }}"
