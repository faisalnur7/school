...
<div class="container-fluid hub-container">
    <div class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-700 via-teal-600 to-cyan-500 p-8 mb-8">
    ...
    <x-hub-card-browser :cards="$cards" storage-key="budget" default-view="medium" />
</div>
@endsection
