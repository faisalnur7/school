...
@section('page_title', 'Edit Police Station')

@section('contents')
<div class="container-fluid">
    <div class="card">
        <div class="card-header bg-gradient-dark text-white rounded-top">
            <h3 class="card-title">Edit Police Station</h3>
        </div>
        <div class="card-body">
            <form action="{{ route('police-station.update', $station->id) }}" method="POST">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <select name="district_id" class="form-control @error('district_id') is-invalid @enderror" required>
                        @foreach ($districts as $district)
                            <option value="{{ $district->id }}" {{ $district->id == $station->district_id ? 'selected' : '' }}>
                                {{ $district->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="bn_name" value="{{ old('bn_name', $station->bn_name) }}"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="url" value="{{ old('url', $station->url) }}"
