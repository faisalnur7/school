...
@endphp
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .report-card__grades th { font-weight: 700; }
        .report-card__title {
            text-align: center;
            font-size: 22px;
            font-weight: 800;
        ...
        .report-card__student td { padding: 2px 7px 2px 0; vertical-align: top; white-space: nowrap; }
        .report-card__student td:first-child { font-weight: 700; width: 60px; }
        ...
        .report-card__table thead th { font-weight: 700; }
        .report-card__table .group-row th { font-size: 14px; padding: 6px 4px; }
        .report-card__table .group-row th span { font-size: 11px; }
        .report-card__table .sub-row th { font-size: 11px; }
        .report-card__table .grand-total { font-size: 16px; font-weight: 800; }
...
@php
    ...
    $logoPath = !empty($school->logo) && file_exists(public_path($school->logo)) ? public_path($school->logo) : (!empty($school->logo) ? asset($school->logo) : null);
    ...
    <div class="report-card">
        ...
        <div class="report-card__top">
            <div class="report-card__identity">
                ...
                @endif
                <div class="report-card__school" style="flex:1;text-align:center;">
        ...
        <div class="report-card__meta">
            <div>
                ...
                <table class="report-card__student">
                    ...
                    <tr>
                        <td>Class</td><td>:</td><td>{{ $classLabel }}</td>
                    </tr>
                    <tr>
                        <td>ID</td><td>:</td><td>{{ $row['student']->student_cid ?? $row['student']->id }}</td>
                    </tr>
                    <tr>
