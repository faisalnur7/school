        ...
        <div class="card-header bg-gradient-primary text-white py-3">
            <div class="d-flex justify-content-between align-items-center">
                <h4 class="card-title mb-0 font-weight-bold text-white">
                    <i class="fas fa-edit mr-2"></i>Edit Shareholder
                </h4>
                <a href="{{ route('shareholders.index') }}" class="btn btn-light btn-sm">
                    <i class="fas fa-arrow-left mr-1"></i> Back
                </a>
            </div>
        </div>

        <form method="POST" action="{{ route('shareholders.update', $shareholder->id) }}" id="modernForm">
            @csrf
...
<div class="form-group">
            ...
            <div class="card-footer bg-light border-top py-2 px-3">
                <div class="d-flex justify-content-between gap-2">
                    <a href="{{ route('shareholders.index') }}" class="btn btn-secondary btn-sm">
