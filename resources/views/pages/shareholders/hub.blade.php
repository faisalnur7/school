...
<div class="container-fluid hub-container">
    <div class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-rose-700 via-pink-600 to-fuchsia-500 p-8 mb-8">
        ...
        <div class="relative z-10 flex items-center gap-6">
            ...
            <div>
                <h3 class="text-white text-3xl font-bold m-0">{{ __('Shareholders') }}</h3>
                <p class="text-rose-100 text-base mt-1 mb-0">{{ __('Manage shareholders') }}</p>
            </div>
        </div>
    </div>
    
    <x-hub-card-browser :cards="$cards" storage-key="shareholders" default-view="medium" />
</div>
@endsection
