...
<div class="container-fluid hub-container">
    ...
    <div class="hub-mobile-hide-hero relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-800 via-slate-700 to-slate-600 p-8 mb-8">
        ...
        <div class="relative z-10 flex items-center gap-6">
            ...
            <div>
                <h3 class="text-white text-3xl font-bold m-0">{{ __('Financials') }}</h3>
                <p class="text-slate-300 text-base mt-1 mb-0">{{ __('Manage incomes, expenses & transactions') }}</p>
            </div>
        </div>
    </div>
