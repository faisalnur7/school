        ...
        <form method="GET" class="supplier-dues-filters">
            <div class="row g-2 align-items-end">
                ...
                <div class="col-md-6 d-flex gap-2">
                    ...
                    <a href="{{ route('reports.cash-flow') }}" class="btn btn-light" title="Reset" aria-label="Reset">
                        <i class="fas fa-undo-alt"></i>
                    </a>
                    <a href="{{ route('reports.cash-flow.pdf', request()->query()) }}" class="btn btn-danger" title="PDF" aria-label="PDF">
