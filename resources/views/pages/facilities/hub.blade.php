    ...
    <div class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-teal-700 via-cyan-600 to-sky-500 p-8 mb-8">
        ...
        <div class="relative z-10 flex items-center gap-6">
            ...
            <div>
                ...
                <p class="text-teal-100 text-base mt-1 mb-0">Manage facility rentals & booking income</p>
            </div>
        </div>
    </div>
    
    <x-hub-card-browser :cards="$cards" storage-key="facilities" default-view="medium" />
</div>
@endsection
