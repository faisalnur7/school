        ...
        <div class="card shadow-sm border-0">
            ...
            <form method="POST" action="{{ route('subjects.store') }}" id="modernForm">
                ...
                <div class="card-body p-3 space-y-4">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="type" id="type" class="form-control" required>
                                    <option value="mandatory" {{ old('type') == 'mandatory' ? 'selected' : '' }}>Mandatory
                                    </option>
                                    <option value="optional" {{ old('type') == 'optional' ? 'selected' : '' }}>Optional
                                    </option>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    <input type="checkbox" name="has_multiple_papers" id="has_multiple_papers"
                                        ...
                                        {{ old('has_multiple_papers') ? 'checked' : '' }}>
                                    <label class="form-check-label" for="has_multiple_papers">
                                        Has Multiple Papers (Combined Subject)
                                    </label>
                                    <small class="d-block text-muted">Check if this subject consists of multiple papers
                                        (e.g., Bangla 1st Paper, 2nd Paper)</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="form-check">
                                    <input type="checkbox" name="combine_papers_for_result" id="combine_papers_for_result"
                                        class="form-check-input" value="1"
                                        {{ old('combine_papers_for_result', '1') == '1' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="combine_papers_for_result">
                                        Combine Papers for Result
                                    </label>
                                    <small class="d-block text-muted">If checked, total marks = sum of all papers'
                                        marks</small>
                                </div>
                            </div>
                        </div>
                    ...
                    <p class="text-muted">Define marks for this subject. If class-wise configuration is needed, use the
                        Class Configs section below.</p>

                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="creative_marks">Creative Marks (CQ)</label>
                                <input type="number" name="creative_marks" id="creative_marks"
                                    class="form-control marks-input" value="{{ old('creative_marks', 0) }}" min="0"
                                    step="0.01">
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" name="practical_marks" id="practical_marks"
                                    class="form-control marks-input" value="{{ old('practical_marks', 0) }}"
                                    min="0" step="0.01">
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" name="tutorial_marks" id="tutorial_marks" class="form-control"
                                    value="{{ old('tutorial_marks', 0) }}" min="0" step="0.01"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="total_marks" readonly value="0.00"
                                    disabled>
                            </div>
                        </div>
                    </div>
                    ...
                    <p class="text-muted">Override default marks for specific classes. Leave empty to use subject defaults.
                    </p>
                    ...
                    <p class="text-muted">Select multiple classes to assign this subject. Compulsory subjects will be
                        auto-assigned to all students in the class.</p>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="exclusive_group_key" id="exclusive_group_key"
                                        class="form-control" value="{{ old('exclusive_group_key') }}"
                                        placeholder="e.g., science_core_choice">
                                    <small class="text-muted">Used for mutually exclusive subject groups (e.g., Biology vs
                                        Higher Math)</small>
                                </div>
                            </div>
                        </div>
