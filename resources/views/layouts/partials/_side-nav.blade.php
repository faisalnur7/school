    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <!-- Academics -->
                <li class="nav-item has-treeview  {{ menuOpen(['classes.*','sections.*','groups.*','sessions.*','subjects.*','classrooms.*']) ? 'menu-is-opening menu-open' : '' }}">
                    <a href="#" class="nav-link">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li><a href="{{ route('subjects.index') }}" class="nav-link {{ request()->routeIs('subjects.*') ? 'active' : '' }}"><i class="far fa-circle nav-icon"></i>Subjects</a></li>
                        <li><a href="{{ route('routines.index') }}" class="nav-link"><i class="far fa-circle nav-icon"></i>Class Routine</a></li>
                        <li><a href="{{ route('rooms.index') }}" class="nav-link {{ request()->routeIs('rooms.*') ? 'active' : '' }}"><i class="far fa-circle nav-icon"></i>Class Room</a></li>
                    </ul>
                </li>
    ...
    <ul class="nav nav-treeview">
        ...
        <li class="nav-item has-treeview {{ menuOpen($accounts) }}">
            ...
            <ul class="nav nav-treeview">
                ...
                <!-- Institute Settings -->
                <li class="nav-item has-treeview {{ menuOpen(['school-settings.*','id-card-templates.*', 'buildings.*', 'rooms.*']) ? 'menu-is-opening menu-open' : '' }}">
                    <a href="#" class="nav-link">
                        <i class="nav-icon fas fa-school"></i>
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li>
                            <a href="{{ route('buildings.index') }}" class="nav-link {{ request()->routeIs('buildings.*') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>Buildings
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('rooms.index') }}" class="nav-link {{ request()->routeIs('rooms.*') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>Rooms
                            </a>
                        </li>
                    </ul>
                </li>
