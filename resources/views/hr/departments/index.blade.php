...
<div class="container-fluid">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="card-title mb-0 text-white text-lg">Departments</h3>
            <a href="{{ route('hr.departments.create') }}" class="btn btn-primary btn-sm ml-auto"><i class="fas fa-plus"></i> Add</a>
        </div>
        <div class="card-body">
            @include('hr._alerts')
