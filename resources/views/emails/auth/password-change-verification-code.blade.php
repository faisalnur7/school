...
<body style="font-family: Arial, sans-serif; background:#f8fafc; padding:24px; color:#0f172a;">
    <div style="max-width:560px; margin:0 auto; background:#fff; border:1px solid #e2e8f0; border-radius:12px; padding:24px;">
        ...
        <h2 style="margin:0 0 10px; font-size:20px;">Password Change Verification</h2>
        <p style="margin:0 0 12px; color:#334155;">Hi {{ $user->name }},</p>
        <p style="margin:0 0 16px; color:#334155;">Use this 6-digit code to change your password:</p>
        ...
        <p style="margin:0; color:#475569;">If you did not request password change, please secure your account.</p>
