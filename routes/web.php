...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::middleware('permission:view_attendance')->get('/attendance/hub', [AttendanceHubController::class, 'index'])->name('attendance.hub');
    Route::middleware('permission:view_students')->get('/students/hub', [StudentsHubController::class, 'index'])->name('students.hub');
    ...
    Route::middleware('permission:view_institute_settings')->get('/institute/hub', [InstituteHubController::class, 'index'])->name('institute.hub');
    Route::middleware('permission:view_location_settings')->get('/location/hub', [LocationHubController::class, 'index'])->name('location.hub');
    ...
    // ------------------- Online Learning & LMS -------------------
    Route::middleware('permission:view_academics')->prefix('lms')->group(function () {
    ...
    // ------------------- Lesson Plan -------------------
    Route::middleware('permission:view_academics')->prefix('lessonplan')->group(function () {
    ...
    Route::middleware('permission:view_academics')->group(function () {
    ...
    Route::middleware('permission:view_students,view_card_add_student')->group(function () {
        ...
        Route::get('/students/birthdays/{student}/card/preview', [\App\Http\Controllers\StudentBirthdayController::class, 'birthdayCardPreview'])->name('students.birthdays.card.preview');
    ...
    Route::middleware('permission:manage_teacher_section_assignments')->group(function () {
    ...
    // ------------------- Student Services (Aggregate permission for student wellbeing) -------------------
    Route::middleware('permission:view_students')->prefix('health')->group(function () {
    ...
    Route::middleware('permission:view_students')->prefix('discipline')->group(function () {
    ...
    Route::middleware('permission:view_students')->prefix('activities')->group(function () {
    ...
    Route::middleware('permission:view_students')->prefix('sports')->group(function () {
    ...
    Route::middleware('permission:view_students')->prefix('clubs')->group(function () {
    ...
    Route::middleware('permission:view_students')->prefix('counseling')->group(function () {
    ...
    Route::middleware('permission:manage_income_categories')->prefix('income-categories')->group(function () {
    ...
    Route::middleware('permission:manage_expense_categories')->prefix('expense-categories')->group(function () {
    ...
    Route::middleware('permission:manage_incomes')->prefix('incomes')->group(function () {
    ...
    Route::middleware('permission:manage_mobile_banking_accounts')->prefix('mobile-banking-accounts')->group(function () {
    ...
    Route::middleware('permission:manage_hand_cash')->prefix('hand-cash')->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::get('/fees/student-ledger', [\App\Http\Controllers\StudentLedgerReportController::class, 'index'])->name('fees.student-ledger.index');
    ...
    Route::middleware('permission:manage_scholarships')->prefix('scholarships')->group(function () {
    ...
    Route::middleware('permission:manage_free_studentships')->prefix('free-studentships')->group(function () {
    ...
    // ------------------- Procurement & Budget -------------------
    Route::middleware('permission:view_budget')->prefix('procurement')->group(function () {
    ...
    // ------------------- Exams & Results -------------------
    Route::middleware('permission:manage_exams')->prefix('exams')->name('exams.')->group(function () {
...
Route::middleware('permission:view_results')->prefix('result/progress-report')->name('result.progress-report.')->group(function () {
    ...
    // ------------------- Analytics -------------------
    Route::middleware('permission:view_academics')->prefix('analytics')->group(function () {
    ...
    // ------------------- Library -------------------
    Route::middleware('permission:view_academics')->get('/library', [LibraryController::class, 'index'])->name('library.index');

    // ------------------- Transport -------------------
    Route::middleware('permission:manage_transports')->prefix('transports')->group(function () {
    ...
    Route::middleware('permission:manage_transports')->get('/transport', [TransportController::class, 'index'])->name('transport.index');

    // ------------------- Dormitory -------------------
    Route::middleware('permission:view_students')->get('/dormitory', [DormitoryController::class, 'index'])->name('dormitory.index');
    ...
    Route::middleware('permission:manage_shareholder_transactions')->group(function () {
    ...
    // ------------------- Accounts Module -------------------
    Route::middleware('permission:manage_account_groups')->resource('account-groups', \App\Http\Controllers\AccountGroupController::class)->except(['create','edit','show']);
    Route::middleware('permission:manage_accounts_list')->resource('accounts-list', \App\Http\Controllers\AccountsController::class)->except(['show']);
    ...
    // ------------------- Asset Tracking -------------------
    Route::middleware('permission:manage_asset_issues')->group(function () {
    ...
    // ------------------- Budget Control -------------------
    Route::middleware('permission:manage_budget_allocations')->group(function () {
    ...
    // ------------------- HR & Payroll -------------------
    Route::middleware('permission:view_hr')->prefix('hr')->name('hr.')->group(function () {
        ...
        Route::middleware('permission:manage_departments')->resource('departments', \App\Http\Controllers\HR\DepartmentController::class)->except(['show']);
        ...
        Route::middleware('permission:manage_salary_structures')->group(function () {
        ...
        Route::middleware('permission:manage_payroll')->group(function () {
            ...
            Route::get('payroll/{month}/{year}', [\App\Http\Controllers\HR\PayrollController::class, 'show'])->whereNumber('month')->whereNumber('year')->name('payroll.show');
    ...
    Route::middleware('permission:manage_id_card_templates')->resource('id-card-templates', \App\Http\Controllers\IdCardTemplateController::class)->except(['show']);
    Route::middleware('permission:manage_buildings')->resource('buildings', BuildingController::class)->except(['show']);
    Route::middleware('permission:manage_buildings')->resource('rooms', RoomController::class)->except(['show']);
    ...
    // ------------------- Accounting Periods -------------------
    Route::middleware('permission:manage_accounting_periods')->group(function () {
    ...
    // ------------------- Asset Management -------------------
    Route::middleware('permission:manage_asset_categories')->prefix('asset-categories')->group(function () {
    ...
    Route::middleware('permission:manage_assets')->prefix('manage-assets')->group(function () {
    ...
    Route::middleware('permission:manage_asset_purchases')->prefix('asset-purchases')->group(function () {
    ...
    // ------------------- Facility Bookings -------------------
    Route::middleware('permission:view_assets')->group(function () {
    ...
    Route::middleware('permission:view_inventory')->group(function () {
        Route::prefix('inventory')->group(function () {
            ...
            Route::middleware('permission:manage_inventory_suppliers')->group(function () {
            ...
            Route::middleware('permission:manage_inventory_purchases')->group(function () {
    ...
    Route::middleware('permission:manage_id_card_templates')->prefix('idcards')->group(function () {
    ...
    Route::middleware('permission:view_students')->prefix('certificates')->group(function () {
    ...
    // ------------------- Teachers -------------------
    Route::middleware('permission:manage_employees')->prefix('teachers')->group(function () {
    ...
    Route::middleware('permission:manage_employees')->prefix('hr')->group(function () {
    ...
    Route::middleware('permission:view_institute_settings')->prefix('mobile')->group(function () {
    ...
    Route::middleware('permission:delete_roles')->delete('/roles/{role}', [RoleController::class, 'destroy'])->name('roles.destroy');
    ...
    Route::middleware('permission:manage_districts')->prefix('district')->group(function () {
    ...
    Route::middleware('permission:manage_police_stations')->prefix('police-station')->group(function () {
    ...
    Route::middleware('permission:manage_post_offices')->prefix('post-office')->group(function () {
    ...
    // ------------------- AJAX Calls (no permission needed) -------------------
