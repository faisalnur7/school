...
class PasswordChangeVerificationCodeMail extends Mailable
{
    ...
    {
        return new Envelope(subject: 'Your Password Change Verification Code');
    }
    ...
    public function content(): Content
    {
        ...
        return new Content(
            view: 'emails.auth.password-change-verification-code',
            with: [
