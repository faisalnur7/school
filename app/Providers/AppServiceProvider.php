...
class AppServiceProvider extends ServiceProvider
{
    ...
    private function buildAdminNavigationMeta(string $routeName): array
    {
        ...
        $hubMap = [
            ...
            'lms.' => ['route' => 'academics.hub', 'label' => 'Academics'],
            'lessonplan.' => ['route' => 'academics.hub', 'label' => 'Academics'],
            'lessonplans.' => ['route' => 'academics.hub', 'label' => 'Academics'],
            'topics.' => ['route' => 'academics.hub', 'label' => 'Academics'],
            'discipline.' => ['route' => 'academics.hub', 'label' => 'Academics'],
            'timetable.' => ['route' => 'academics.hub', 'label' => 'Academics'],
