    ...
    public function index()
    {
        $sections = [
            ...
            'Reports' => [
                ...
                ['icon' => 'fa-layer-group',    'title' => 'All In One Report',    'subtitle' => 'Payment, receive and receivable reports', 'route' => 'fees.all-in-one-report', 'permission' => 'view_card_student_payment_report', 'from' => '#8b5cf6', 'to' => '#4f46e5'],
                ...
                ['icon' => 'fa-user-clock',     'title' => 'Student Due',        'subtitle' => 'Fee and inventory due report', 'route' => 'fees.student-due-report', 'permission' => 'view_card_student_due_report', 'from' => '#b45309', 'to' => '#92400e'],
