...
class ShareholdersHubController extends Controller
{
    public function index()
    {
        $cards = [
            ...
            ['icon' => 'fa-hand-holding-usd', 'title' => 'Shareholder Contribution','subtitle' => 'Capital & share percentage', 'route' => 'shareholders.contribution',       'permission' => 'view_card_all_shareholders',        'from' => '#0891b2', 'to' => '#0e7490'],
        ];
