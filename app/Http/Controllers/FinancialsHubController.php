...
class FinancialsHubController extends Controller
{
    public function index()
    {
        $cards = [
            ...
            ['icon' => 'fa-coins',             'title' => 'Capital',             'subtitle' => 'Shareholder capital entries', 'route' => 'shareholder-transactions.create', 'permission' => 'view_card_capital', 'from' => '#d97706', 'to' => '#b45309'],
