...
class InstituteHubController extends Controller
{
    public function index()
    {
        $cards = [
            ...
            ['icon' => 'fa-signature',  'title' => __('Principal Signature'), 'subtitle' => __('Edit principal designation and signature details'), 'route' => 'school-settings.index', 'url' => route('school-settings.index') . '#principal-signature', 'permission' => 'view_card_school_settings', 'from' => '#be185d', 'to' => '#db2777'],
