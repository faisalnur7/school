        ...
        $roles = [
            ...
            [
                ...
                'permissions' => [
                    ...
                    'view_academics',
                    'view_admission_management', 'view_admission_exams', 'create_admission_exams', 'edit_admission_exams', 'delete_admission_exams',
                    'view_admission_applications', 'view_admission_payments', 'verify_admission_payments',
                    'manage_admission_admit_cards', 'enter_admission_marks', 'view_admission_results',
                    'review_admission_applications', 'proceed_admission',
            ...
            [
                ...
                'permissions' => [
                    ...
                    'view_fees',
                    'view_admission_management', 'view_admission_applications', 'view_admission_payments', 'view_approved_admission_students',
                    'verify_admission_payments', 'view_converted_admissions', 'proceed_admission',
                    'view_financials', 'manage_incomes', 'manage_expenses', 'manage_transactions',
